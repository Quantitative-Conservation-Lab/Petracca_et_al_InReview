...
#additive <- .5 #fully additive (0.5 means partly compensatory)
...
save(Lambda.mean, #lambda.upper, lambda.lower,
     ...
     NSite_state.mean, NSite_EWash.mean, NSite_NCasc.mean, NSite_SCasc.mean, file="Outputs/a_composite_model/Scenarios/10_harvest_025perc_additive_RSF_Oct31.RData")
