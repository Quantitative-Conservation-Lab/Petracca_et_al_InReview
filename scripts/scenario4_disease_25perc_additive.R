...
save(Lambda.mean, #lambda.upper, lambda.lower,
     ...
     NSite_state.mean, NSite_EWash.mean, NSite_NCasc.mean, NSite_SCasc.mean, file="Outputs/a_composite_model/Scenarios/4_disease_25perc_additive_RSF_Oct31.RData")
