...
source("Scripts/a_composite_model/removals_function_allWA.R")
...
save(Lambda.mean, #lambda.upper, lambda.lower,
     ...
     NSite_state.mean, NSite_EWash.mean, NSite_NCasc.mean, NSite_SCasc.mean, file="Outputs/a_composite_model/Scenarios/17_incremovals_allWA_RSF_Oct31.RData")
