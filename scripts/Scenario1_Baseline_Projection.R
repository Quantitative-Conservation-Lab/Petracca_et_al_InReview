...
save(Lambda.mean,
     ...
     BP_Presence_summary, BP_Presence, Pack_Size, Pack_Size_max,Two_Adult_summary,Two_Adult,
     Nglobal_state.mean, Nglobal_state_wmove.mean,
     NAdult_state.mean,
     NAdult_EWash.mean, NAdult_NCasc.mean, NAdult_SCasc.mean, Newguys.mean,
     NSite_state.mean, NSite_EWash.mean, NSite_NCasc.mean, NSite_SCasc.mean, file="1_Baseline_Projection_wPackSize.RData")